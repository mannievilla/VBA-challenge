...
'LastRow = sht.Cells.SpecialCells(xlCellTypeLastCell).Row
    ...
    For Each sht In Worksheets
       ' MsgBox (sht.Name)
            ...
            If Cells(i + 1, 1).Value <> Cells(i, 1).Value Then
                ...
                Cells(Brand_Summary_Row, "J").Value = Yearly_Change
                    ...
                    If Open_Value = 0 Then
                        ...
                        Cells(Brand_Summary_Row, "K").Value = Yearly_Change
                        
                        Else
                        
                        Cells(Brand_Summary_Row, "K").Value = FormatPercent(Yearly_Change / Open_Value, 2)
                        
                            If Cells(Brand_Summary_Row, "K").Value < 0 Then
                            
                                Cells(Brand_Summary_Row, "K").Interior.ColorIndex = 3
                                
                                Else
                                
                                Cells(Brand_Summary_Row, "K").Interior.ColorIndex = 4
        ...
        LastRow = 0 'remember to reset values
